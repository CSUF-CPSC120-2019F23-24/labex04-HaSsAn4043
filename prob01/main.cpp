...
int main()
{
  ...
  char my_char1 = 'J';
  short my_short1 = 74 ;
  std::cout << "The ASCII value for " << static_cast<int>(my_char1) << " is " << my_short1 << std::endl;
  ...
  char my_char3 = 'z';
  my_char3 = my_char3 + 1 ;
  std::cout << "Char2: " << my_char3 << std::endl; // Curly bracket is shown
  ...
  // max for short was exceeded so it goes to lowest value
  ...
  // int goes up to 65535 so it doesn't become negative when adding 1
    << std::hex << " (0x" << my_int2 << ")\n";
  ...
  // max for unsighned short was exceeded
